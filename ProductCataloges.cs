    ...
    public class ProductCataloges
    {
        ...
        public void HaalproductenUitDatabase()
        {
            ...
            foreach (string product in producten)
            {
                ...
                {
                    DigitaalProduct digitaalProduct = new DigitaalProduct(eigenschappen[0], ProductType.Digitaal, Convert.ToDouble(eigenschappen[2]), eigenschappen[3]);
                    AlleProducten.Add(digitaalProduct);
                }
                else if (eigenschappen[1] == "Fysiek")
                {
                    FysiekProduct fysiekProduct = new FysiekProduct(eigenschappen[0], ProductType.Fysiek, Convert.ToDouble(eigenschappen[2]), eigenschappen[3]);
